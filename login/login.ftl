                    ...
                    <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                            ...
                            <#else>
                                <div class="cds--input__field-outer-wrapper">
                                    <div class="cds--text-input__field-wrapper" data-invalid="<#if messagesPerField.existsError('username','password')>true</#if>">
                                        ...
                                        <input id="username" class="${properties.kcInputClass!} <#if messagesPerField.existsError('username','password')>cds--text-input--invalid</#if>" name="username" value="${(login.username!'')}"  type="text" autofocus autocomplete="off"
                        ...
                        <div id="kc-form-buttons" class="${properties.kcFormGroupClass!}">
                            ...
                            <button class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!}" name="login" id="kc-login" type="submit">
                                ${msg("doLogIn")}
                                <svg width="16" height="16" fill="currentColor" fill-rule="evenodd" class="cds--btn__icon" viewBox="0 0 22 22">
